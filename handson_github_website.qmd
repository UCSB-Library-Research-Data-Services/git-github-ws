...
![](img/github-dessert-repo.png){fig-alt="Screenshot on information to provide to create a new repository on GitHub"}
...
```{r echo=FALSE, fig-alt="README content at the end of adding your name and favorite dessert "}
...
```{r echo=FALSE, fig-alt="Screenshot of a commit message box on GitHub website"}
knitr::include_graphics("img/github-commit.png")
```

- Click _Commit changes_ to confirm

```{r commit-button, out.width="20%", echo=FALSE, fig-alt="Green commit button on GitHub website"}
