...
![GitHub dasboard view](img/github_overview-01_dashboard.png)
...
![GitHub user profile view](img/github_overview-02_user.png)
...
![GitHub organization view](img/github_overview-03_organization.png){fig-align="center" width=90%}
...
![GitHub reposiotry view](img/ss3sim-github_colored.png){fig-align="center" width=80%}
...
![GitHub reposiotry history](img/ss3sim-commits_colored.png){fig-align="center" width=80%}

And finally, if we drill into the changes made on June 13, we can see exactly what
was changed in each file:

![GitHub diff changes between versions](img/ss3sim-diff.png){fig-align="center" width=80%}
